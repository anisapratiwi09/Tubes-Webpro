...
$.ajax({
    ...
    success     : function(data){
        ...
        document.getElementsByClassName("tweet")[0].innerHTML = DataList;
    }
});
...
$('#fotopf').html('<a href=""><img class="img-responsive" alt="" src="'+data.url_image+'" width="800" height="500"></a>');
 $('#fotosml').html('<img alt="" class="media-object img-rounded" src="'+data.url_image+'" width="32" height="32"></div>');
});
// End of your code
